...
| Studio + opc-monitor, cert profile Sign/SignAndEncrypt; fail-closed PKI; username + **X.509 user tokens** | industrial CA lifecycle / RBAC |
| OTel metrics + poll/write traces; OTLP exporters + **live collector smoke in CI** | — |
